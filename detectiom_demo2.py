...
image_path   = "./gohar_rep/drone.jpg"
video_path   = "./gohar_rep/MFD.mp4"
video_path   = "./gohar_rep/ZOHD.mp4"
...
YOLO_TYPE = "yolov4"
YOLO_V4_WEIGHTS= "gohar_rep/yolov4-tiny-custom.weights"
YOLO_COCO_CLASSES="gohar_rep/classes.names"
YOLO_INPUT_SIZE=608
...
def Load_Yolo_model():
    ...
    if YOLO_FRAMEWORK == "trt": # TensorRT detection
...
detect_image(yolo, image_path, "./gohar_rep/drone1.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
#detect_video(yolo, video_path, "./gohar_rep/MFD", input_size=YOLO_INPUT_SIZE, show=False, rectangle_colors=(255,0,0))
